        ...
        <>
            <ReactMarkdown
                ...
                components={{
                    ...
                    li: ({ children }) => <li className='text-sm md:text-lg my-2'>{children}</li>,
                    p: ({ children }) => <p className='text-sm md:text-lg my-2'>{children}</p>,
                    img: ({ src, alt }) => <Image src={String(src)} alt={String(alt)} className='object-fit w-11/12 max-w-xl' width={300} height={300} />,
                    blockquote: ({ children }) => <blockquote className='border-l-2 border-primary-700 p-2 my-3 bg-primary-50 rounded-r'>{children}</blockquote>,
